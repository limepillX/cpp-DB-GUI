...
// Yakovenko_4.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CYakovenko_4App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CYakovenko_4App::OnAppAbout)
	// Стандартная команда настройки печати
	ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinApp::OnFilePrintSetup)
END_MESSAGE_MAP()


// создание CYakovenko_4App

CYakovenko_4App::CYakovenko_4App()
{
	...
	SetAppID(_T("Yakovenko_4.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CYakovenko_4App

CYakovenko_4App theApp;


// инициализация CYakovenko_4App

BOOL CYakovenko_4App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CYakovenko_4Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CYakovenko_4View));
	if (!pDocTemplate)
		return FALSE;
...
int CYakovenko_4App::ExitInstance()
{
...
// обработчики сообщений CYakovenko_4App
...
void CYakovenko_4App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
